...
// Tag-related methods
func (r *PostgresProductRepository) GetProductTags(ctx context.Context, productID string) ([]models.ProductTag, error) {
	query := `
...
func (r *PostgresProductRepository) AddProductTag(ctx context.Context, tag *models.ProductTag) error {
	now := time.Now().UTC()
	tag.CreatedAt = now
	tag.UpdatedAt = now
...
func (r *PostgresProductRepository) RemoveProductTag(ctx context.Context, productID, tag string) error {
	query := `
...
func (r *PostgresProductRepository) GetProductAttributes(ctx context.Context, productID string) ([]models.ProductAttribute, error) {
	query := `
...
func (r *PostgresProductRepository) AddProductAttribute(ctx context.Context, attribute *models.ProductAttribute) error {
	now := time.Now().UTC()
...
func (r *PostgresProductRepository) UpdateProductAttribute(ctx context.Context, attribute *models.ProductAttribute) error {
	now := time.Now().UTC()
	attribute.UpdatedAt = now
...
func (r *PostgresProductRepository) RemoveProductAttribute(ctx context.Context, attributeID string) error {
	query := `
...
// SEO-related methods
func (r *PostgresProductRepository) GetProductSEO(ctx context.Context, productID string) (*models.ProductSEO, error) {
	query := `
...
func (r *PostgresProductRepository) UpsertProductSEO(ctx context.Context, seo *models.ProductSEO) error {
	now := time.Now().UTC()
	seo.UpdatedAt = now
...
func (r *PostgresProductRepository) GetProductShipping(ctx context.Context, productID string) (*models.ProductShipping, error) {
	query := `
...
func (r *PostgresProductRepository) UpsertProductShipping(ctx context.Context, shipping *models.ProductShipping) error {
	now := time.Now().UTC()
...
func (r *PostgresProductRepository) AddProductDiscount(ctx context.Context, discount *models.ProductDiscount) error {
	now := time.Now().UTC()
...
func (r *PostgresProductRepository) UpdateProductDiscount(ctx context.Context, discount *models.ProductDiscount) error {
	now := time.Now().UTC()
	discount.UpdatedAt = now
...
func (r *PostgresProductRepository) RemoveProductDiscount(ctx context.Context, discountID string) error {
	query := `
...
func (r *PostgresProductRepository) GetInventoryLocations(ctx context.Context, productID string) ([]models.InventoryLocation, error) {
	query := `
...
func (r *PostgresProductRepository) UpsertInventoryLocation(ctx context.Context, location *models.InventoryLocation) error {
	now := time.Now().UTC()
...
func (r *PostgresProductRepository) RemoveInventoryLocation(ctx context.Context, productID, warehouseID string) error {
	query := `
