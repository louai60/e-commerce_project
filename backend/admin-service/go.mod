...
require (
	...
	github.com/louai60/e-commerce_project/backend/product-service v0.0.0-20250402183010-f93986bd0d61
	github.com/louai60/e-commerce_project/backend/user-service v0.0.0-20250402183010-f93986bd0d61
